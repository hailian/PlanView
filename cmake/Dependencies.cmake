...
# 网络环境变化时可用 -D SOFTG_IMGUI_REPO=... / -D SOFTG_JSON_REPO=... 覆盖。
...
set(SOFTG_IMGUI_REPO "https://gitee.com/zzzzhan3_pri/imgui.git" CACHE STRING "imgui 仓库")
set(SOFTG_JSON_REPO  "https://gitee.com/mirrors/nlohmann-json.git" CACHE STRING "nlohmann/json 仓库")
...
FetchContent_Declare(
    imgui
    GIT_REPOSITORY ${SOFTG_IMGUI_REPO}
    GIT_TAG ${IMGUI_TAG}
    GIT_SHALLOW TRUE
)
...
FetchContent_Declare(
    nlohmann_json
    GIT_REPOSITORY ${SOFTG_JSON_REPO}
    GIT_TAG v3.12.0
    GIT_SHALLOW TRUE
)
